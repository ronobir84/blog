 ...
 <body>
     ...
     <nav  class="  w-full h-[85px] border-gray-200  bg-[#FFFFFF]  z-10  shadow-md  block ">
         <div class="flex flex-wrap justify-between py-5 px-[70px] ">
                         ...
                         <li>
                             <div class="relative inline-block text-left">
                                 <div class="group">
                                     ...
                                     <!-- Dropdown menu -->
                                     <div class="absolute left-0 w-[151px]   mt-1 origin-top-left bg-[#FFFFFF] divide-y divide-gray-100 shadow-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-700 z-10">
                                         <div class="py-1">
                                             <?php
                                                if ($rows) {
             ...
             <div>
                 <?php
                    ...
                    ?>
                 <form class="flex items-center space-x-6 rtl:space-x-reverse" action="search.php" method="get">
                     <input class="bg-slate-50   font-mono  ring-zinc-400     duration-300 placeholder:text-zinc-600 placeholder:opacity-50 rounded-sm px-8 py-3 shadow-md focus:shadow-lg  border0 border-purple-500     " placeholder="Search" name="keyword" required maxlength="70" autocomplete="off" value="<?php echo $keyword ?>" type="search" />
                     <div class=" relative right-[23px] ">
                         <button class="px-5 py-3 bg-gray-800 text-lg font-semibold text-white">Search</button>
                     </div>
                 </form>
