                        ...
                        <li>
                            <div class="relative inline-block text-left">
                                <div class="group">
                                    ...
                                    <!-- Dropdown menu -->
                                    <div class="absolute left-0 w-[151px] h-28 mt-1 origin-top-left bg-white divide-y divide-gray-100 shadow opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-700">
                                        <div class="py-1">
                                            <a href="#" class="block px-4 py-2 text-lg text-center font-semibold text-gray-700 hover:bg-gray-300">Politics</a>
                                            <a href="#" class="block px-4 py-2 text-center text-lg font-semibold text-gray-700 hover:bg-gray-300">Sports</a>
