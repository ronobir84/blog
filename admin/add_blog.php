...
<div class="w-[850px] h-[850px]  bg-gray-500 mx-auto">
    ...
    if (isset($_SESSION['error_sms'])) {
        $er_msg = $_SESSION['error_sms'];
        echo "<span class='text-xl font-semibold text-green-700 absolute  right-[35%] mt-4'>" . $er_msg . "</span>";
...
if ( isset($_POST['add_blog'])) {
    ...
    if (in_array($image_ext, $allow_type)) {
       if ($size <= 2000000) {
        ...
        echo "image size should be 2mb";
       }
    }else{
        echo "File type is not allow";
    }
